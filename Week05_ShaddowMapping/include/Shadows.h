...
protected:
	...
	void SetupFrameBuffer(unsigned int& a_fbo, unsigned int width, unsigned int height, unsigned int& a_renderTexture, unsigned int& a_depthTexture);

	void DrawScene(unsigned int a_programID);
